...
const NewsTypeManager = () => {
    ...
    const getUsersList = async (kw = keyword, pg = page, pgSize = pageSize) => {
        ...
        let config = {
            ...
            url: `https://server.realestatevn.xyz/api/newsType-paging?page=${pg - 1}&size=${pgSize}&keyword=${kw}`,
            headers: {}
        };
    ...
    const fetchDataCatory = async () => {
        let config = {
            method: 'get',
            maxBodyLength: Infinity,
            url: 'https://server.realestatevn.xyz/api/caterorys',
            headers: {}
        };
...
const LockNewsType = async()=>{
    let config = {
        method: 'post',
        maxBodyLength: Infinity,
        url: `https://server.realestatevn.xyz/api/newsTypesLock?idNewsType=${idNewsTypeLock}`,
        headers: { }
      };
